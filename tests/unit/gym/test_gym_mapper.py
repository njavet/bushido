...
from bushido.adapter.mapper.gym import Mapper
from bushido.persistence.models.gym import GymUnitTable
...
def test_correct_to_orm_mapping(
    mapper: Mapper, parsed_unit: Unit[Data], unit: GymUnitTable
) -> None:
