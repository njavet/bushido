...
name_options_line = "name --option 0 --option 1"
name_options_comment_line = "name --option 0 --option 1 # testing options"
name_options_flag_line = "name --option 0 -z"
name_options_flag_comment_line = "name --option 0 -z # testing options"
